...
def read_grade_data(filename: str) -> List[Dict[str, str]]:
    ...
    try:
        ...
        for line in lines[1:]:
            ...
            # BUG 1: Using wrong split character - file uses commas, not semicolons
...
def calculate_student_average(student: Dict[str, str]) -> float:
    ...
    """
    # BUG 2: Not converting string grades to numbers before calculating average
...
def find_class_statistics(students: List[Dict[str, str]]) -> Dict[str, float]:
    ...
    averages = []
    # BUG 3: Not starting at index 0 and going beyond end of list
...
def generate_grade_report(
    ...
    # BUG 4: Index error - trying to access students[i] but iterating over student objects
...
def main() -> None:
    ...
    # BUG 5: Passing arguments in wrong order
